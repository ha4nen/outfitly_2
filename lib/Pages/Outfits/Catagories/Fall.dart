...
class FallOutfitsPage extends StatefulWidget {
  final List<File> outfits;

  const FallOutfitsPage({
    super.key,
    required this.outfits,
  });

  @override
  State<FallOutfitsPage> createState() => _FallOutfitsPageState();
}

class _FallOutfitsPageState extends State<FallOutfitsPage> {
