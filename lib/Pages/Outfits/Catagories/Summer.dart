...
class SummerOutfitsPage extends StatefulWidget {
  final List<File> outfits;

  const SummerOutfitsPage({
    super.key,
    required this.outfits,
  });

  @override
  State<SummerOutfitsPage> createState() => _SummerOutfitsPageState();
}

class _SummerOutfitsPageState extends State<SummerOutfitsPage> {
