...
class WinterOutfitsPage extends StatefulWidget {
  final List<File> outfits;

  const WinterOutfitsPage({
    super.key,
    required this.outfits,
  });

  @override
  State<WinterOutfitsPage> createState() => _WinterOutfitsPageState();
}

class _WinterOutfitsPageState extends State<WinterOutfitsPage> {
